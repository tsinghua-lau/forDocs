import{_ as s,o as n,c as a,R as l}from"./chunks/framework.af956f17.js";const p="/images/web/promise.gif",u=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"studyCn/Javascript/Promise.md"}'),o={name:"studyCn/Javascript/Promise.md"},e=l(`<h2 id="promise-控制并发" tabindex="-1">Promise 控制并发 <a class="header-anchor" href="#promise-控制并发" aria-label="Permalink to &quot;Promise 控制并发&quot;">​</a></h2><div class="tip custom-block"><p class="custom-block-title">TIP</p><p>设计一个函数，可以限制请求的并发，同时请求结束之后，调用callback函数 sendRequest(requestList:,limits,callback):void</p></div><div class="language-javascript"><button title="Copy Code" class="copy"></button><span class="lang">javascript</span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#82AAFF;">sendRequest</span><span style="color:#A6ACCD;">(</span></span>
